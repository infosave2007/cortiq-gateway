...
Overhead шлюза при проксировании одного и того же мгновенного бэкенда, `ab -k -r -c 20 -n 5000`:
...
(`bash bench/run.sh`). Абсолютные числа зависят от железа; важны соотношения.
